<template lang="html">
  <div id="declickMap">
    ...
    <button @click="updateState()">Mise à jour étape 1</button>
    <button @click="updateCurrent()">Mise à jour étape courante</button>
    <div id="text"></div>
    <button @click="show()">Apparaître</button>
  </div>
...
export default {
  ...
  methods: {
    ...
    updateState () {
      var _this = this
        this.map.updateState([{id:1, passed:_this.passed}]);
